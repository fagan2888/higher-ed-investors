# This code was originally authored by Benjamin Bengfort. See below.
# We added a function for loading BLS dataset - which doesn't work yet.
...
DATA_DIR = os.path.join(BASE_DIR, "data/bls")
...
def load_bls():
    """
    Loads the bls data set by creating a target set of Y1.
    """
    data = load_data('bls/dataset.csv')
